...
// ImGui_ImplGlfw_InstallCallbacks() is called. GLFW callbacks will be
// installed for you. They will chain-call user's previously installed
// callbacks, if any.
// - When calling Init with 'install_callbacks=false': GLFW callbacks won't
// be installed. You will need to call individual function yourself from
// your own GLFW callbacks.
...
// GLFW callbacks (individual callbacks to call yourself if you didn't
// install callbacks)
...
IMGUI_IMPL_API void ImGui_ImplGlfw_CursorPosCallback(
    GLFWwindow* window, double x, double y);  // Since 1.87
